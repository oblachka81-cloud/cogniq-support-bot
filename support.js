...
const LANG = {
  ...
  es: {
    ...
    faq_play: '🎮 **¿Cómo jugar a NEURON?**\n\n1️⃣ Abre Mini App con "Jugar"\n2️⃣ Responde preguntas del quiz\n3️⃣ Gana COGNIQ\n4️⃣ Usa COGNIQ en intercambio y banco\n\n🎁 ¡Recibe IMPULSE gratis cada día!\n\n🔗 https://neuron1.bothost.tech',
    faq_cogniq: '🪙 **¿Qué es COGNIQ?**\n\nCOGNIQ es el token del ecosistema NEURON en TON.\n\n🔹 Gana en el quiz\n🔹 Intercambia por IMPULSE\n🔹 Usa en intercambio y banco\n🔹 Retira a billetera TON\n\n📄 Whitepaper: https://neuron1.bothost.tech/whitepaper.html',
    faq_exchange: '💱 **NEURON EXCHANGE**\n\nOpera:\n🔹 Crypto: TON, BTC, USDT\n🔹 Acciones: Apple, Tesla, NVIDIA (xStocks)\n🔹 Oro: XAUt0\n\n🔗 Abrir: https://neuron1.bothost.tech/exchange.html',
...
bot.action('lang_menu', async (ctx) => {
  ...
  await ctx.reply('🌐 Select language / Выберите язык / Choisissez la langue / Seleccione el idioma:', {
    reply_markup: {
      inline_keyboard: [
